package com.example.kompasandroidassessment.view.adapters
...
import com.example.kompasandroidassessment.databinding.ItemsUserBinding
...
class FavoriteAdapter(private val callback: OnUserFavCallback)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int
        ...
        val binding = ItemsUserBinding.inflate(
